...
class Human(models.Model):
    MALE_SEX = "M"
    FEMALE_SEX = "F"
    SEX_CHOICES = ((MALE_SEX, _("Male")), (FEMALE_SEX, _("Female")))
    ...
    national_id_type = models.IntegerField(_("National id type"), choices=NATIONAL_ID_TYPE_CHOICES, default=NATIONAL_ID)
